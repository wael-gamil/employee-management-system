<template>
  <div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
      <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 hover:shadow-md transition-all duration-200">
        <div class="flex items-center justify-between">
          <div>
            <p class="text-sm font-medium text-gray-600 dark:text-gray-400">System Version</p>
            <p class="text-2xl font-bold text-gray-900 dark:text-white mt-1">{{ systemInfo.version || '1.0.0' }}</p>
          </div>
        ...
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-2xl font-bold text-gray-900 dark:text-white mt-1">{{ systemInfo.users?.active || 0 }}</p>
          </div>
        ...
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-2xl font-bold text-gray-900 dark:text-white mt-1">{{ systemInfo.storage?.percentage || 0 }}%</p>
          </div>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 hover:shadow-md transition-all duration-200">
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-sm font-bold text-gray-900 dark:text-white mt-1">{{ formatBackupDate(systemInfo.lastBackup || 'Never') }}</p>
          </div>
    ...
    <div v-if="settings.system?.maintenanceMode" class="maintenance-mode-warning border rounded-lg p-4 mb-6">
      <div class="flex items-center space-x-3">
        ...
        <div>
          ...
          <p class="text-sm">The system is currently in maintenance mode. New users cannot access the application.</p>
        </div>
      </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm overflow-hidden">
      ...
      <!-- Settings Content -->
      <div class="p-6">        <!-- System Settings -->
        <div v-if="activeTab === 'system'" class="space-y-6">
          <div>
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">System Configuration</h3>
            <p class="text-sm text-gray-500 dark:text-gray-400 mb-6">Configure general system settings and preferences.</p>
          </div>

          <div v-if="settings.system" class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="space-y-4">
              <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Application Name</label>                <input
                  v-model="settings.system.appName"
                  @input="handleSettingChange('system', 'appName', $event.target.value)"
                  type="text"
              ...
              <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Timezone</label>                <select
                  v-model="settings.system.timezone"
                  @change="handleSettingChange('system', 'timezone', $event.target.value)"
            ...
            <div class="space-y-4">
              <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                ...
                <label class="relative inline-flex items-center cursor-pointer">                  <input
                    ...
                    @change="handleSettingChange('system', 'maintenanceMode', $event.target.checked)"
                    type="checkbox"
                    class="sr-only peer"
                  />
              ...
              <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                <div>
                  <h4 class="text-sm font-medium text-gray-900 dark:text-white">Allow Registration</h4>
              ...
              <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                <div>
                  <h4 class="text-sm font-medium text-gray-900 dark:text-white">Backup Enabled</h4>
                  <p class="text-xs text-gray-500 dark:text-gray-400">Automatic data backups</p>
                </div>
                <label class="relative inline-flex items-center cursor-pointer">
                  <input
        ...
        <div v-else-if="activeTab === 'security'" class="space-y-6">
          <div>
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">Security Configuration</h3>
            <p class="text-sm text-gray-500 dark:text-gray-400 mb-6">Configure password policies and security features.</p>
          </div>

          <div v-if="settings.security" class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="space-y-4">
              <div>
              ...
              <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Password Expiration (days)</label>
                <input
            ...
            <div class="space-y-4">
              <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                <div>
                  <h4 class="text-sm font-medium text-gray-900 dark:text-white">Require Uppercase</h4>
                  <p class="text-xs text-gray-500 dark:text-gray-400">Passwords must contain uppercase letters</p>
                </div>
                <label class="relative inline-flex items-center cursor-pointer">
                  <input
              ...
              <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                <div>
                  <h4 class="text-sm font-medium text-gray-900 dark:text-white">Require Numbers</h4>
                  <p class="text-xs text-gray-500 dark:text-gray-400">Passwords must contain numbers</p>
                </div>
                <label class="relative inline-flex items-center cursor-pointer">
                  <input
              ...
              <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                <div>
                  ...
                  <p class="text-xs text-gray-500 dark:text-gray-400">Enable 2FA for enhanced security</p>
                </div>
                <label class="relative inline-flex items-center cursor-pointer">
                  <input
        ...
        <div v-else-if="activeTab === 'audit'" class="space-y-6">
          <div>
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400 mb-6">System activity and security events.</p>
          </div>
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <div class="text-xs text-gray-500 dark:text-gray-400">{{ log.details }}</div>
                  </div>
                </div>
        ...
        <div v-else-if="activeTab === 'backup'" class="space-y-6">
          <div>
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">Backup & Recovery</h3>
            <p class="text-sm text-gray-500 dark:text-gray-400 mb-6">Manage data backups and system recovery.</p>
          </div>

          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="space-y-4">
              <div class="p-6 border border-gray-200 dark:border-gray-700 rounded-lg">
                <h4 class="text-lg font-medium text-gray-900 dark:text-white mb-2">Create Backup</h4>
                <p class="text-sm text-gray-500 dark:text-gray-400 mb-4">Export all system data including settings, users, and content.</p>
                <button
                  @click="createBackup"
                  :disabled="isLoading"
              ...
              <div class="p-6 border border-gray-200 dark:border-gray-700 rounded-lg">
                <h4 class="text-lg font-medium text-gray-900 dark:text-white mb-2">Export Settings</h4>
                <p class="text-sm text-gray-500 dark:text-gray-400 mb-4">Export only system settings configuration.</p>
                <button
            ...
            <div class="space-y-4">
              <div class="p-6 border border-gray-200 dark:border-gray-700 rounded-lg">
                <h4 class="text-lg font-medium text-gray-900 dark:text-white mb-2">Import Settings</h4>
                <p class="text-sm text-gray-500 dark:text-gray-400 mb-4">Import settings from a backup file.</p>
                <input
                  ref="fileInput"
                  type="file"
                  accept=".json"
              ...
              <div class="p-6 border border-red-200 dark:border-red-700 rounded-lg bg-red-50 dark:bg-red-900/20">
                <h4 class="text-lg font-medium text-red-900 dark:text-red-200 mb-2">Reset Settings</h4>
                <p class="text-sm text-red-600 dark:text-red-300 mb-4">Reset all settings to default values. This action cannot be undone.</p>
                <button
        ...
        <div v-else-if="activeTab === 'notifications'" class="space-y-6">
          <div>
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">Notification Configuration</h3>
            <p class="text-sm text-gray-500 dark:text-gray-400 mb-6">Configure email and system notification preferences.</p>
          </div>

          <div v-if="settings.notifications" class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <!-- Email Settings -->
            <div class="space-y-6">
              <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-6">
                <h4 class="text-lg font-medium text-gray-900 dark:text-white mb-4">Email Configuration</h4>
            ...
            <div class="space-y-6">
              <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-6">
                <h4 class="text-lg font-medium text-gray-900 dark:text-white mb-4">Notification Types</h4>
                
                <div class="space-y-4">
                  <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                    <div>
                      <h5 class="text-sm font-medium text-gray-900 dark:text-white">Welcome Emails</h5>
                      <p class="text-xs text-gray-500 dark:text-gray-400">Send welcome email to new users</p>
                    </div>
                    <label class="relative inline-flex items-center cursor-pointer">
                      <input
                  ...
                  <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                    <div>
                      <h5 class="text-sm font-medium text-gray-900 dark:text-white">Password Reset</h5>
                      <p class="text-xs text-gray-500 dark:text-gray-400">Password reset notifications</p>
                    </div>
                    <label class="relative inline-flex items-center cursor-pointer">
                      <input
                  ...
                  <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                    <div>
                      <h5 class="text-sm font-medium text-gray-900 dark:text-white">Account Lockout</h5>
                      <p class="text-xs text-gray-500 dark:text-gray-400">Notify when account is locked</p>
                    </div>
                    <label class="relative inline-flex items-center cursor-pointer">
                      <input
                  ...
                  <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                    <div>
                      <h5 class="text-sm font-medium text-gray-900 dark:text-white">System Alerts</h5>
                      <p class="text-xs text-gray-500 dark:text-gray-400">Critical system notifications</p>
                    </div>
                    <label class="relative inline-flex items-center cursor-pointer">
                      <input
        ...
        <div v-else-if="activeTab === 'integrations'" class="space-y-6">
          <div>
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">Integration Configuration</h3>
            <p class="text-sm text-gray-500 dark:text-gray-400 mb-6">Configure third-party service integrations.</p>
          </div>

          <div v-if="settings.integrations" class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <!-- Slack Integration -->
            <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-6">
              <div class="flex items-center space-x-3 mb-4">
                <div class="w-10 h-10 bg-purple-500 rounded-lg flex items-center justify-center">
                  <svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M5.042 15.165a2.528 2.528 0 0 1-2.52-2.523A2.528 2.528 0 0 1 5.042 10.1a2.528 2.528 0 0 1 2.52 2.542 2.528 2.528 0 0 1-2.52 2.523Zm6.958-4.165a2.528 2.528 0 0 1-2.52-2.523A2.528 2.528 0 0 1 12 5.935a2.528 2.528 0 0 1 2.52 2.542A2.528 2.528 0 0 1 12 11Zm6.958 4.165a2.528 2.528 0 0 1-2.52-2.523A2.528 2.528 0 0 1 18.958 10.1a2.528 2.528 0 0 1 2.52 2.542 2.528 2.528 0 0 1-2.52 2.523Zm-6.958 4.165a2.528 2.528 0 0 1-2.52-2.523A2.528 2.528 0 0 1 12 14.265a2.528 2.528 0 0 1 2.52 2.542A2.528 2.528 0 0 1 12 19.33Z"/>
                  </svg>
                </div>
                <div>
                  <h4 class="text-lg font-medium text-gray-900 dark:text-white">Slack</h4>
                  <p class="text-sm text-gray-500 dark:text-gray-400">Team communication integration</p>
                </div>
              </div>
              
              <div class="space-y-4">
                <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                  <span class="text-sm font-medium text-gray-900 dark:text-white">Enable Slack Integration</span>
                  <label class="relative inline-flex items-center cursor-pointer">
                    <input
                ...
                <div v-if="settings.integrations.slack.enabled">
                  <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Default Channel</label>
                  <input
                ...
                <div v-if="settings.integrations.slack.enabled" class="flex space-x-2">
                  <button
            ...
            <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-6">
              <div class="flex items-center space-x-3 mb-4">
                <div class="w-10 h-10 bg-blue-500 rounded-lg flex items-center justify-center">
                  <svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M20.625 5.625v12.75c0 .345-.28.625-.625.625H4c-.345 0-.625-.28-.625-.625V5.625C3.375 5.28 3.655 5 4 5h16c.345 0 .625.28.625.625z"/>
                  </svg>
                </div>
                <div>
                  <h4 class="text-lg font-medium text-gray-900 dark:text-white">Microsoft Teams</h4>
                  <p class="text-sm text-gray-500 dark:text-gray-400">Enterprise communication platform</p>
                </div>
              </div>
              
              <div class="space-y-4">
                <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                  <span class="text-sm font-medium text-gray-900 dark:text-white">Enable Teams Integration</span>
                  <label class="relative inline-flex items-center cursor-pointer">
                    <input
            ...
            <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-6">
              <div class="flex items-center space-x-3 mb-4">
                ...
                <div>
                  <h4 class="text-lg font-medium text-gray-900 dark:text-white">Single Sign-On</h4>
                  <p class="text-sm text-gray-500 dark:text-gray-400">SAML/OAuth authentication</p>
                </div>
              </div>
              ...
              <div class="space-y-4">
                ...
                <div v-if="settings.integrations.sso.enabled">
                  <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Entity ID</label>
                  <input
            ...
            <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-6">
              <div class="flex items-center space-x-3 mb-4">
                ...
                <div>
                  <h4 class="text-lg font-medium text-gray-900 dark:text-white">LDAP</h4>
                  <p class="text-sm text-gray-500 dark:text-gray-400">Directory service integration</p>
                </div>
              </div>
              
              <div class="space-y-4">
                <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                  <span class="text-sm font-medium text-gray-900 dark:text-white">Enable LDAP</span>
                  <label class="relative inline-flex items-center cursor-pointer">
                    <input
                ...
                <div v-if="settings.integrations.ldap.enabled">
                  <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Base DN</label>
                  <input
        ...
        </div>        <!-- Interface Settings -->
        <div v-else-if="activeTab === 'interface'" class="space-y-6">
          <div>
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">Interface Configuration</h3>
            <p class="text-sm text-gray-500 dark:text-gray-400 mb-6">Customize the user interface and user experience.</p>
          </div>

          <div v-if="settings.interface" class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <!-- Theme & Appearance -->
            <div class="space-y-6">
              <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-6">
                <h4 class="text-lg font-medium text-gray-900 dark:text-white mb-4">Theme & Appearance</h4>
                
                <div class="space-y-4">
                  <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Color Theme</label>                    <select
                      v-model="settings.interface.theme"
                      @change="handleSettingChange('interface', 'theme', $event.target.value)"
                      class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white"
                    >
                  ...
                  <div>
                    ...
                    <div class="flex space-x-2">                      <input
                        ...
                        @input="handleSettingChange('interface', 'primaryColor', $event.target.value)"
                        type="color"
                  ...
                  <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                    <div>
                      <h5 class="text-sm font-medium text-gray-900 dark:text-white">Compact Sidebar</h5>
                      <p class="text-xs text-gray-500 dark:text-gray-400">Use compact navigation sidebar</p>
                    </div>
                    <label class="relative inline-flex items-center cursor-pointer">
                      <input
                  ...
                  <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                    <div>
                      <h5 class="text-sm font-medium text-gray-900 dark:text-white">Show Breadcrumbs</h5>
                      <p class="text-xs text-gray-500 dark:text-gray-400">Display navigation breadcrumbs</p>
                    </div>
                    <label class="relative inline-flex items-center cursor-pointer">
                      <input
            ...
            <div class="space-y-6">
              <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-6">
                <h4 class="text-lg font-medium text-gray-900 dark:text-white mb-4">Localization</h4>
                ...
                <div class="space-y-4">
                  ...
                  <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Number Format</label>
                    <select
                  ...
                  <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                    <div>
                      <h5 class="text-sm font-medium text-gray-900 dark:text-white">Right-to-Left Layout</h5>
                      <p class="text-xs text-gray-500 dark:text-gray-400">Enable RTL layout support</p>
                    </div>
                    <label class="relative inline-flex items-center cursor-pointer">
                      <input
                  ...
                  <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                    <div>
                      <h5 class="text-sm font-medium text-gray-900 dark:text-white">Enable Animations</h5>
                      <p class="text-xs text-gray-500 dark:text-gray-400">Enable UI transitions and animations</p>
                    </div>
                    <label class="relative inline-flex items-center cursor-pointer">
                      <input
              ...
              <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-6">
                <h4 class="text-lg font-medium text-gray-900 dark:text-white mb-4">Table Settings</h4>
                
                <div class="space-y-4">
                  <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Default Page Size</label>
                    <select
                  ...
                  <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                    <div>
                      <h5 class="text-sm font-medium text-gray-900 dark:text-white">Show Row Numbers</h5>
                      <p class="text-xs text-gray-500 dark:text-gray-400">Display row numbers in tables</p>
                    </div>
                    <label class="relative inline-flex items-center cursor-pointer">
                      <input
        ...
        <div v-else class="text-center py-12">
          ...
          <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-white">{{ activeTab }} Settings</h3>
          <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Settings for this category are coming soon.</p>
        </div>
      </div>

      <!-- Save Actions -->
      <div v-if="hasUnsavedChanges" class="border-t border-gray-200 dark:border-gray-700 px-6 py-4 bg-gray-50 dark:bg-gray-700">
        <div class="flex items-center justify-between">
...
const sendTestEmail = async () => {
  ...
  try {
    ...
    const emailData = {
      ...
      body: `This is a test email from ${settings.value.system?.appName || 'Employee Management System'}.\n\nSMTP Configuration:\nHost: ${emailSettings.smtpHost}\nPort: ${emailSettings.smtpPort}\nEncryption: ${emailSettings.encryption}\n\nIf you received this email, your email configuration is working correctly.`,
      smtp: {
        host: emailSettings.smtpHost,
        port: emailSettings.smtpPort,
        encryption: emailSettings.encryption,
...
const testSlackIntegration = async () => {
  ...
  try {
    ...
    const testMessage = {
      ...
      text: `🔧 Test message from ${settings.value.system?.appName || 'EMS'}\n\nSlack integration is working correctly!\n\nTimestamp: ${new Date().toISOString()}`,
