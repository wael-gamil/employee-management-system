      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
        ...
        <div>
          ...
          >
            ...
            <option
              v-for="status in Object.values(PROJECT_STATUSES)"
              :key="status"
              :value="status"
            >
              {{ status }}
        ...
        <div>
          ...
          >
            ...
            <option
              v-for="priority in Object.values(PROJECT_PRIORITIES)"
              :key="priority"
              :value="priority"
            >
              {{ priority }}
            ...
            >
                ...
                <div>
                  ...
                  <div class="flex flex-wrap gap-1 mt-1">
                    <span
                      ...
                      :key="tag"
                      class="inline-flex items-center px-2 py-1 text-xs font-medium bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200 rounded"
                    >
                      {{ tag }}
                    </span>
                    <span
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                <div class="flex -space-x-1 overflow-hidden">
                  <div
                    v-for="memberId in project.teamMembers.slice(0, 3)"
                    :key="memberId"
                    class="inline-block h-8 w-8 rounded-full ring-2 ring-white dark:ring-gray-800 bg-gradient-to-r from-purple-400 to-pink-400 flex items-center justify-center"
                  >
                    <span class="text-xs font-medium text-white">{{
                      getEmployeeInitials(memberId)
                    }}</span>
                  </div>
                  <div
                    v-if="project.teamMembers.length > 3"
                    class="inline-block h-8 w-8 rounded-full ring-2 ring-white dark:ring-gray-800 bg-gray-500 flex items-center justify-center"
                  >
                    <span class="text-xs font-medium text-white"
          ...
          <div class="space-y-3">
            ...
            <div>
              ...
              <div class="flex items-center space-x-1">
                <div
                  v-for="(memberId, index) in project.teamMembers.slice(0, 4)"
                  :key="memberId"
                  class="h-8 w-8 rounded-full ring-2 ring-white dark:ring-gray-800 bg-gradient-to-r from-purple-400 to-pink-400 flex items-center justify-center"
                >
                  <span class="text-xs font-medium text-white">{{
                    getEmployeeInitials(memberId)
                  }}</span>
                ...
                <div
                  v-if="project.teamMembers.length > 4"
                  class="h-8 w-8 rounded-full ring-2 ring-white dark:ring-gray-800 bg-gray-500 flex items-center justify-center"
                >
                  <span class="text-xs font-medium text-white"
                    >+{{ project.teamMembers.length - 4 }}</span
                  >
                </div>
              </div>
            </div>
          ...
          <div class="flex items-center justify-between">
            <div class="flex items-center space-x-1">
              <button
                v-if="hasPermission('edit_project')"
                @click="editProject(project)"
                class="p-1.5 text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-300 hover:bg-indigo-50 dark:hover:bg-indigo-900/20 rounded transition-colors duration-200"
                title="Edit project"
              >
                <svg
                  class="w-4 h-4"
              ...
              <button
                v-if="hasPermission('delete_project')"
                @click="deleteProjectConfirm(project)"
                class="p-1.5 text-red-600 hover:text-red-900 dark:text-red-400 dark:hover:text-red-300 hover:bg-red-50 dark:hover:bg-red-900/20 rounded transition-colors duration-200"
                title="Delete project"
              >
                <svg
                  class="w-4 h-4"
...
export default {
  ...
  setup() {
    ...
    const bulkDelete = () => {
      if (
        confirm(
          `Are you sure you want to delete ${selectedProjects.value.length} projects?`
        )
      ) {
