      ...
      <div class="p-6">
        ...
        <div class="flex items-center justify-center mb-8">
          <div class="flex items-center space-x-4">
            <div :class="['w-8 h-8 rounded-full flex items-center justify-center text-sm font-medium', currentStep >= 1 ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-600 dark:bg-gray-700 dark:text-gray-400']">1</div>
            <div :class="['w-16 h-1', currentStep > 1 ? 'bg-blue-600' : 'bg-gray-200 dark:bg-gray-700']"></div>
            <div :class="['w-8 h-8 rounded-full flex items-center justify-center text-sm font-medium', currentStep >= 2 ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-600 dark:bg-gray-700 dark:text-gray-400']">2</div>
            <div :class="['w-16 h-1', currentStep > 2 ? 'bg-blue-600' : 'bg-gray-200 dark:bg-gray-700']"></div>
            <div :class="['w-8 h-8 rounded-full flex items-center justify-center text-sm font-medium', currentStep >= 3 ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-600 dark:bg-gray-700 dark:text-gray-400']">3</div>
          </div>
        </div>
          ...
          <div v-if="currentStep === 3" class="space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <div class="space-y-2 max-h-48 overflow-y-auto">
                  <div v-for="permission in form.permissions" :key="permission" class="bg-blue-100 dark:bg-blue-900 px-3 py-2 rounded-lg text-sm text-blue-800 dark:text-blue-200">
                    {{ permission }}
                  </div>
                </div>
              </div>
